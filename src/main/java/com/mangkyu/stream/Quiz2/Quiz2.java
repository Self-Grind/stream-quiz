...
public class Quiz2 {
    ...
    public Map<String, Integer> quiz1() {
        Map<String, Integer> lst =
                WORDS.stream()
                        .map(word -> word.substring(0, 1))
                        .collect(Collectors.toMap(words -> words, words -> 1, (o, n)-> n += o));

        for (String character : lst.keySet()) {
            System.out.println(character + " = " + lst.get(character));
